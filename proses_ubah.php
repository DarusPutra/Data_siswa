...
if(isset($_POST['ubah_foto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
  ...
  if(move_uploaded_file($tmp, $path)){ // Jika proses upload sukses
    ...
    $sql = $pdo->prepare("UPDATE siswa SET nama=:nama, jenis_kelamin=:jk, jurusan=:jurusan foto=:foto WHERE nis=:nis");
  ...
  // Proses ubah ke Database
  $sql = $pdo->prepare("UPDATE siswa SET nama=:nama, jenis_kelamin=:jk, jurusan=:jurusan WHERE nis=:nis");
  $sql->bindParam(':nama', $nama);
  $sql->bindParam(':nis', $nis);
  $sql->bindParam(':jk', $jenis_kelamin);
  $sql->bindParam(':jurusan', $jurusan);
